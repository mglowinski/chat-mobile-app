...
@AllArgsConstructor
public class AddFileRoomNotificationStrategy implements NotificationMethod {
    ...
    public void reactOnNotification(Object object) {
        AddFileBody addFileBody = (AddFileBody) object;
        int roomPosition = getRoomPosition(addFileBody.getRoomId());

        markRoom(roomPosition);
        setRoomToStore(addFileBody.getRoomId());
